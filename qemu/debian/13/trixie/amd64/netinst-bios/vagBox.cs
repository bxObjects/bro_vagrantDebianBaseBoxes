...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]] Create symlinks to poly base dir.
        ...
        # ln -s ../../../../../../poly/debian/13/netinst/13.trixie-netinst-bios_us.pkr.hcl us.pkr.hcl
        polyBaseDir = "../../../../../../poly/debian/13/netinst"

        pathPlus.symlink_update(f"{polyBaseDir}/13.trixie-netinst-bios_us.pkr.hcl", "us.pkr.hcl",)
        ...
        pathPlus.symlink_update(f"{polyBaseDir}/Vagrantfile.template", "Vagrantfile.template",)
